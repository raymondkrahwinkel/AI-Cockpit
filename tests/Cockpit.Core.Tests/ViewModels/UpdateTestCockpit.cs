...
/// <summary>
/// A cockpit built for the update tests: twelve required collaborators that have nothing to do with updates, and the
/// two that do. Shared so the banner tests and the channel-choice tests cannot drift into building subtly different
/// cockpits and disagreeing about which one was wrong.
/// </summary>
internal static class UpdateTestCockpit
{
    public static CockpitViewModel Build(IUpdateService updates, IUpdateSettingsStore? updateSettings = null)
    {
