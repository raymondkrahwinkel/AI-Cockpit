...
/// existing state is already under. How <see cref="CockpitBuild.StateRoot"/> itself resolves is in
/// <see cref="StateRootOverrideTests"/>, which must hold the environment still while it asks.
/// </remarks>
