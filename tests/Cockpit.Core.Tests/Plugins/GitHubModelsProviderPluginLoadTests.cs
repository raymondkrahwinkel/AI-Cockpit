...
public class GitHubModelsProviderPluginLoadTests
{
    ...
    public void ActivatesAndRegistersTheSessionProvider_WhenBuilt()
    {
        ...
        Assert.Equal("Cockpit.Plugin.GitHubModelsProvider.UI.dll", manifest.UiAssembly);
        Assert.Equal("Cockpit.Plugin.GitHubModelsProvider.UI.GitHubModelsProviderUi", manifest.UiEntryType);
        ...
        uiHost.Received(1).AddProviderConfigView("github-models-provider.github-models", Arg.Any<Func<string?, IPluginProviderConfigView>>());
