...
public class GrokProviderPluginLoadTests
{
    ...
    public void ActivatesAndRegistersTheSessionProvider_WhenBuilt()
    {
        ...
        Assert.Equal("Cockpit.Plugin.GrokProvider.UI.dll", manifest.UiAssembly);
        Assert.Equal("Cockpit.Plugin.GrokProvider.UI.GrokProviderUi", manifest.UiEntryType);
        ...
        uiHost.Received(1).AddProviderConfigView("grok-provider.grok", Arg.Any<Func<string?, IPluginProviderConfigView>>());
