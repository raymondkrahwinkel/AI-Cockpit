...
/// <summary>
/// Covers <see cref="ClaudeTtySessionProvider.BuildArguments"/> in isolation — mirrors the teststyle used for
...
/// </summary>
public class ClaudeTtySessionProviderBuildArgumentsTests
{
    [Fact]
    public void BuildArguments_WithNothingSelected_IsEmpty()
    {
        var arguments = ClaudeTtySessionProvider.BuildArguments(permissionMode: null, model: null, effort: null);
    ...
    {
        var arguments = ClaudeTtySessionProvider.BuildArguments(permissionMode: "acceptEdits", model: null, effort: null);
    ...
    {
        var arguments = ClaudeTtySessionProvider.BuildArguments(permissionMode: "bypassPermissions", model: null, effort: null);
    ...
    {
        var arguments = ClaudeTtySessionProvider.BuildArguments(permissionMode: null, model: "opus", effort: null);
    ...
    {
        var arguments = ClaudeTtySessionProvider.BuildArguments(permissionMode: null, model: null, effort: "high");
    ...
    {
        var arguments = ClaudeTtySessionProvider.BuildArguments(permissionMode: "default", model: "sonnet", effort: "max");
    ...
    public void BuildArguments_WithAnMcpConfigPath_AddsMcpConfigWithoutStrictFlag()
    {
        ...
        var arguments = ClaudeTtySessionProvider.BuildArguments(permissionMode: null, model: null, effort: null, mcpConfigPath: "/tmp/mcp.json");
    ...
    {
        var arguments = ClaudeTtySessionProvider.BuildArguments(permissionMode: "default", model: null, effort: null, mcpConfigPath: "/tmp/mcp.json");
