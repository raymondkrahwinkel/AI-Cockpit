...
public static class ClaudeConfigDirectory
{
    ...
    /// </summary>
    public static string? ResolveSpawnOverride(ClaudeProfile? profile, string userProfileDirectory)
    {
        if (profile is null)
        {
            return null;
    ...
    /// </summary>
    public static string ResolveConfigJsonDirectory(ClaudeProfile? profile, string userProfileDirectory) =>
