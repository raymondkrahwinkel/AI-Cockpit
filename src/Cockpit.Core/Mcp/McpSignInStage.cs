...
/// <summary>
/// How far a sign-in got before it stopped (AC-457). The cockpit cannot say <em>what</em> refused without risking
/// request or response material in the UI (Iron Law #8), but it can say <em>where</em> it stopped — and that is the
...
public enum McpSignInStage
{
    ...
    /// <summary>The sign-in was handed to the system browser, and nothing ever arrived at the loopback redirect.</summary>
    BrowserRequested,
