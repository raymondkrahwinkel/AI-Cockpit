...
public static class McpToolTokenMath
{
    ...
    // Estimated tokens for the given serialised tool definitions: their total character length ÷ ~4, rounded up.
    ...
    // A compact token count for a label: `850`, `1.2k`, `12k`. Invariant so the "k" and the decimal never shift with the UI culture.
