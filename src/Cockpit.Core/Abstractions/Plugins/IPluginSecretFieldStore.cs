...
/// <summary>
/// The storage keys the plugins keep a credential in, beyond the names the host recognises by itself. The names
/// are not secrets — knowing a plugin stores something under <c>pat</c> tells you nothing — and they have to be
/// readable <em>before</em> the settings are decrypted, since they say which fields to decrypt. So they live in
/// the clear in <c>cockpit.json</c>, next to the encrypted values they describe.
/// </summary>
