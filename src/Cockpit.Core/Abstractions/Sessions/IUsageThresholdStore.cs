...
/// <summary>
/// Where the operator's own usage thresholds live (AC-233), on top of what each provider declared.
/// </summary>
public interface IUsageThresholdStore
{
    /// <summary>
    /// What has been set; empty settings mean every signal follows its provider's declaration.
    /// </summary>
