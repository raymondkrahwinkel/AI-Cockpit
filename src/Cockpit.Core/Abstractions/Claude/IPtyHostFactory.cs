...
/// stays platform-agnostic — it only composes the executable path, environment and size.
/// </summary>
public interface IPtyHostFactory
{
    ...
    /// environment. No CLI arguments: TTY mode always spawns the plain interactive <c>claude</c> TUI.
    /// </summary>
