...
// Internal (AC-204) hides it from user selection but allows explicit mounting; AlwaysMounted also hides it but forces it into every session regardless of selection. AC-1148: NodeOnly keeps its node listener while never being offered to a session, which neither of those can express.
