...
/// <summary>
/// Loads and persists the New-session dialog's remembered working directories (<see cref="WorkingPathHistory"/>) in
/// <c>cockpit.json</c>. When nothing was ever saved, <see cref="LoadAsync"/> returns <see cref="WorkingPathHistory.Empty"/>.
/// The <c>Record</c>/<c>SetFavorite</c> helpers apply the corresponding <see cref="WorkingPathHistory"/> mutation and save, returning the new state.
/// </summary>
