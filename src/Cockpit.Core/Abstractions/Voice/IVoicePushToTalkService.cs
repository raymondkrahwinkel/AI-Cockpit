...
public interface IVoicePushToTalkService
{
    ...
    /// because the views and view models that show hold status already hold this interface and nothing else new.
    /// Fires off the UI thread — subscribers marshal themselves.
    /// </summary>
