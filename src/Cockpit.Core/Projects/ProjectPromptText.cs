...
/// <see cref="ProjectInfoField.Tidied"/> and <see cref="Sessions.SessionStartDefaults"/>'s memory note because both
...
internal static class ProjectPromptText
{
    ...
    /// <summary>
    /// <paramref name="text"/> on one line and without the invisible marks — trimmed, hard breaks folded to spaces,
