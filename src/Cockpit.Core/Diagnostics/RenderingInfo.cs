...
// the *live* backend, so `Mode` reports the configured preference and says so honestly rather
// than claiming an active backend it cannot observe; `Detail` carries the platform default that
