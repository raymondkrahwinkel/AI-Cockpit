...
/// (CreateSession, BindShortcuts, Screenshot, ...) only hands back a request object path; the actual result
/// arrives asynchronously as this object's single <c>Response</c> signal.
/// </summary>
