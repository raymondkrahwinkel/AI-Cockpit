...
// AC-1391: public — ProjectsViewModel (Cockpit.App) still constructs it directly across the assembly boundary.
public sealed class ProjectOwnershipRegistry : IProjectOwnershipRegistry, ISingletonService
{
