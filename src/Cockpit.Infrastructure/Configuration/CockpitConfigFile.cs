...
/// the permission-rule store owns <see cref="PermissionRules"/>. Kept as a plain DTO separate from
/// the domain records so the on-disk shape can evolve independently.
/// </summary>
