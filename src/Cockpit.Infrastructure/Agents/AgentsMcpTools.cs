    ...
    IAgentLineBudget budget)
{
    ...
    private static string _WakeReason(AgentWakeOutcome outcome) => outcome switch
    {
        ...
        AgentWakeOutcome.NotWakeable => "The recipient is an address on your desk rather than a session a turn can be started on — the assistant is one. Your message is delivered and it will be read; there is nothing here that urgent could have made faster.",
