...
/// </summary>
/// <param name="Success">
/// Whether a usable executable is now on disk.
/// </param>
/// <param name="Version">
/// The version that was installed or already present, when known.
/// </param>
/// <param name="ExecutablePath">
/// The path to the executable on success; <see langword="null"/> on failure.
/// </param>
/// <param name="Error">
/// A message the caller can surface (a toast, a config-view line) on failure; <see langword="null"/> on success.
/// </param>
