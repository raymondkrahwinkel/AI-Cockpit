...
/// </summary>
/// <param name="Id">
/// Stable id for this activity within its source, so the host can key a panel row to it.
/// </param>
/// <param name="Title">
/// A short line naming the activity, e.g. "nginx-1  :8080 → 80".
/// </param>
/// <param name="Details">
/// Labelled facts shown in the panel, rendered verbatim — source, target, cluster.
/// </param>
/// <param name="StopAsync">
/// Stops the activity; invoked by the host when the operator clicks Kill, never by an agent.
/// </param>
