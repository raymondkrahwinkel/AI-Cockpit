...
/// </summary>
/// <param name="Message">The text to show, e.g. the CLI's own prompt.</param>
/// <param name="LinkToOpen">A URL the operator should visit, when this step names one.</param>
/// <param name="AwaitsInput">True when the flow is blocked on stdin — the host should offer an input field.</param>
