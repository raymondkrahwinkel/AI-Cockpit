...
/// </summary>
/// <param name="Label">
/// The short text the header's bar shows for this window (e.g. "5h", "wk"), chosen by the provider.
/// </param>
/// <param name="UsedPercent">
/// How much of the window is spent, 0-100.
/// </param>
/// <param name="ResetsAt">
/// When the window rolls over, or <see langword="null"/> when the provider did not say.
/// </param>
/// <param name="WindowMinutes">
/// The window's span in minutes, when the provider reports one; <see langword="null"/> otherwise.
/// </param>
