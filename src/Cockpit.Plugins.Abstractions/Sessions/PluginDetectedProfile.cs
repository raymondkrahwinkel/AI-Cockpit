...
/// </summary>
/// <param name="Label">
/// A human name for the detected profile, derived by the provider (e.g. its config directory name).
/// </param>
/// <param name="ConfigJson">
/// The provider's own configuration for this profile, in the shape the plugin defined — the same blob it later receives at launch.
/// </param>
