...
/// <param name="IconKind">Shown above the title on the rail tab; required, since the rail has no text fallback.</param>
/// <param name="CreateView">Builds the panel's content, on the UI thread, once each time it is opened.</param>
