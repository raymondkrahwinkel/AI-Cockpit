...
/// </summary>
/// <param name="Role">
/// What a session does with this row — same plain-string idiom as <see cref="SharedProjectBindingResource.Role"/>.
/// </param>
/// <param name="Reference">
/// Where this resource is, or what names it — exactly as the local project stores it, unfiltered.
/// </param>
/// <param name="Label">
/// What the operator called this row. Null when they never named it.
/// </param>
