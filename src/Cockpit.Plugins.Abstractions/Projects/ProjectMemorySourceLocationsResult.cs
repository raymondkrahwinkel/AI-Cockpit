...
/// <summary>
/// Named outcomes for <see cref="ProjectMemorySourceRegistration.ListLocationsAsync"/> — see each factory for what produces it.
/// </summary>
public enum ProjectMemorySourceLocationsOutcome
{
    ...
    /// <summary>
    /// The source could not answer — see <see cref="ProjectMemorySourceLocationsResult.Error"/>. Never a bare empty list on failure (AC-502 criterion 5).
    /// </summary>
    Failed,

    /// <summary>
    /// The source answered with <see cref="ProjectMemorySourceLocationsResult.Locations"/>, possibly empty.
    /// </summary>
    Success,

    /// <summary>
    /// The source needs a sign-in before it can list anything (AC-502 criterion 4) — offer <see cref="ProjectMemorySourceRegistration.SignInAsync"/>.
    /// </summary>
    AuthorizationRequired,
}

/// <summary>
/// One call's result for <see cref="ProjectMemorySourceRegistration.ListLocationsAsync"/>.
/// </summary>
