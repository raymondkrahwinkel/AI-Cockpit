...
/// </summary>
/// <param name="Name">
/// The project's display name — never blank; the confirmation screen's own guard already ensures that.
/// </param>
/// <param name="Description">
/// Free-text note on what this project is. Null when the project carries none.
/// </param>
/// <param name="GitUrl">
/// The project's own Git source, an offer for whoever binds to it later — same idiom as <c>Project.GitUrl</c>. Null for a project with no source of its own.
/// </param>
/// <param name="BehaviorPrompt">
/// How the profile should behave here, same idiom as <c>Project.BehaviorPrompt</c>. Null appends nothing.
/// </param>
...
/// Names of MCP servers new sessions here start ticked. Null means no opinion — every offered server ticked, the same idiom <see cref="SharedProjectBinding.EnabledMcpServerNames"/> already carries.
/// </param>
/// <param name="Resources">
/// The project's own resource rows, unfiltered — see <see cref="SharedProjectPublishResource"/>.
/// </param>
/// <param name="LogoBytes">
/// The project's own logo, as the cockpit's local store already holds it (AC-763) — null for a project with none.
/// </param>
