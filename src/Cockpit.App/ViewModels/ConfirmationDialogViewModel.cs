...
// server, prompt template, …): a `Title`, a `Message` spelling out exactly what will
// happen, and the label for the confirm button (`ConfirmLabel`, e.g. "Remove"). The dialog returns
