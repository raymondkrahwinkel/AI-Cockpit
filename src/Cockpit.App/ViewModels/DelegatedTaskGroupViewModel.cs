...
public sealed class DelegatedTaskGroupViewModel
{
    ...
    // An empty band is hidden rather than shown as a bare header with nothing under it.
    public bool HasTasks => Tasks.Count > 0;

    // Builds the bands in the order an operator scans them: what is running now, what is next, what is done.
