...
public sealed partial class WorkKindPluginRowViewModel : ObservableObject
{
    ...
    // The published SHA-256 the download is verified against and the install pins, or why there is none.
    ...
    // What to hand the provisioning service for this row; absent on a preview row, which installs nothing.
