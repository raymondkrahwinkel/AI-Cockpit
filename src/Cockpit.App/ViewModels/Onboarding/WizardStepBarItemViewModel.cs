...
// One entry in the wizard's step bar (AC-509): its label, whether it is the step showing now, and whether it is skipped
// — struck through rather than removed, so a skip is something the operator can see happened (AC-540).
