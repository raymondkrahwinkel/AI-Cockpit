...
public sealed record SessionWarningItem(string Key, string Text, bool ShowResumeOffer, bool ShowChangeResumeMoment, bool ShowKill, bool ShowSignInAgain, bool ShowCompact);
