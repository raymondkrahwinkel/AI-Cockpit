...
// budget (`MaxThinkingTokens`) the session runs with. The budget is applied live via
// the `set_max_thinking_tokens` control request — the one budget the control protocol can set
