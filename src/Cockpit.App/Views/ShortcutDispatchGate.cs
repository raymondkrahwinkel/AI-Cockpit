...
// you are prepared to take — see `ShortcutCatalog`, which records why zoom sits on neither Ctrl+Shift+Z
...
{
    // Classifies whatever currently holds the keyboard. `TerminalControl` is a leaf control today, so it
