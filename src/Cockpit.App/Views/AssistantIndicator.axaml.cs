...
/// <summary>
/// The assistant indicator (AC-543) — a plain <see cref="UserControl"/> over
/// <see cref="ViewModels.AssistantIndicatorViewModel"/>, deliberately without a constructor argument or a
