...
// Draws a detailed light-and-dark desktop so selection and redaction effects cannot pass against a flat fill
// (AC-357). Its fixed colours represent somebody else's screen and stay isolated here so only this drawing is
// exempt from the theme-token guard.
