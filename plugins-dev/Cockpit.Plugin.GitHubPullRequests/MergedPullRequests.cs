...
// Which merged pull requests are *news* (#69). The same shape as `ReviewRequestInbox`, and for the
...
{
    // What was merged since the last look, and what to remember. `primed` is false on the very first look, which fires nothing.
...
// What was merged since the last look, and everything to remember for the next one.
