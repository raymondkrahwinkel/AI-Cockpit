...
internal sealed class GitHead(ICliRunner runner)
{
    ...
    // The checkout's HEAD, or null when git is absent or this is not a repository — an unknown commit
    // is a fact to carry, not a reason to fail the run that was about to happen.
