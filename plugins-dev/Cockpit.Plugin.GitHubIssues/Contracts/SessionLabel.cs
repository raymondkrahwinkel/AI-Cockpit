...
internal static class SessionLabel
{
    ...
    // vary. Taking everything past the last separator needs no special case for the repository `gh` can leave
    ...
    // The line under the name: the same short id, plus the title, which is the part you actually read.
