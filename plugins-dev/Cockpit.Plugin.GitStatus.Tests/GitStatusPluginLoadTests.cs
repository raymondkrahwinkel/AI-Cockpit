...
/// <summary>
/// What <see cref="GitStatusPlugin.Initialize"/> registers (AC-522): one settings view, one session-header item,
...
/// <para>
/// Mirrors the counting pattern <c>YouTrackPluginLoadTests</c> uses in the host's own test suite, kept local
...
/// <c>PluginActivator</c>/reflection loading is needed to prove the same thing.
/// </para>
/// </summary>
