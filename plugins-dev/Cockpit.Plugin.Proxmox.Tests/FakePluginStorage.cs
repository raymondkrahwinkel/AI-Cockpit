...
// An in-memory `IPluginStorage` for tests — stores values directly (no JSON round-trip), enough to drive the
// settings layer. Relies on the interface's default secret handling.
