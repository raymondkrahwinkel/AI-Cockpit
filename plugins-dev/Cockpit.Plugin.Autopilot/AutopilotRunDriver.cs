    ...
    Func<AutopilotStep, Task<AutopilotStep>>? holdToCostCeiling = null)
{
    ...
    /// <para>
    /// AC-434: when the next pending work is a review-gate pair (<see cref="AutopilotPlan.NextPendingGroup"/> returns
    /// more than one step), <see cref="_RunReviewGroupAsync"/> runs them concurrently instead of one at a time.
    /// </para>
    /// </summary>
