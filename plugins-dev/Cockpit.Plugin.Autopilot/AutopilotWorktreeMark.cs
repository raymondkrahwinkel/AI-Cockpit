...
// uncommitted work into the next step's evidence. `Commit` pins tracked contents (`git stash create`, falling back to `HEAD`); `UntrackedFiles` pins what git already did not track.
