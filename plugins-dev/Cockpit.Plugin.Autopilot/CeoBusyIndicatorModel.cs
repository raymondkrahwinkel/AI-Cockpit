...
// dialog looking hung. It mirrors `IEmbeddedSession.IsBusy` and follows
// `IEmbeddedSession.BusyChanged`; the state rule is separated from the rendering so it is unit-testable
