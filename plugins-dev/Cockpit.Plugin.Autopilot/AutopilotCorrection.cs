...
/// attempts: <see cref="AutopilotStep.Attempts"/> also grows on a restart that never saw a verdict (a crashed session,
...
{
    /// <summary>The correction, if any, a settled step's status, attempt count and rework count amount to.</summary>
