...
// `IPluginSessionDriver` for this plugin's Gemini/OpenAI providers, over an OpenAI-compatible
// `IChatClient` (#45) — mirrors the shape of the host's own
...
// only (`Capabilities` reports no tool support).
